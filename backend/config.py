...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "sqlite:///./agentdock.db"
    AGENTDOCK_API_KEY: str = "dev-key-change-in-production"
    AGENTDOCK_LLM_PROVIDER: str = "anthropic"
    AGENTDOCK_LLM_MODEL: str = "claude-sonnet-4-20250514"
    AGENTDOCK_LLM_API_KEY: str = ""
    HOST: str = "0.0.0.0"
    PORT: int = 8000
